        ...
        try {
            ...
            foreach ($records as $record) {
                ...
                if ($record['name'] !== '') {
                    ...
                    $billingType = isset($record['billing_type']) && $record['billing_type'] !== '' ? (string) $record['billing_type'] : 'hourly';
                    $this->projectImportHelper->getKey([
                        ...
                        'amount_received' => isset($record['amount_received']) && $record['amount_received'] !== '' && is_numeric($record['amount_received']) ? (int) $record['amount_received'] : null,
